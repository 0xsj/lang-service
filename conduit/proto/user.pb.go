...
type CreateUserRequest struct {
	...
	PhoneNumber string `protobuf:"bytes,3,opt,name=phone_number,json=phoneNumber,proto3" json:"phone_number,omitempty"` // User's phone number (optional)
}
...
type CreateUserResponse struct {
	...
	UserId  string `protobuf:"bytes,1,opt,name=user_id,json=userId,proto3" json:"user_id,omitempty"` // Unique identifier for the newly created user
...
type UpdateUserRequest struct {
	...
	UserId      string `protobuf:"bytes,1,opt,name=user_id,json=userId,proto3" json:"user_id,omitempty"`                // Unique identifier for the user
	Email       string `protobuf:"bytes,2,opt,name=email,proto3" json:"email,omitempty"`                                // Updated email address (optional)
	PhoneNumber string `protobuf:"bytes,3,opt,name=phone_number,json=phoneNumber,proto3" json:"phone_number,omitempty"` // Updated phone number (optional)
}
...
var file_user_proto_rawDesc = []byte{
	...
	0x6f, 0x74, 0x6f, 0x22, 0x65, 0x0a, 0x11, 0x43, 0x72, 0x65, 0x61, 0x74, 0x65, 0x55, 0x73, 0x65,
	...
	0x68, 0x6f, 0x6e, 0x65, 0x4e, 0x75, 0x6d, 0x62, 0x65, 0x72, 0x22, 0x47, 0x0a, 0x12, 0x43, 0x72,
	...
	0x52, 0x05, 0x65, 0x6d, 0x61, 0x69, 0x6c, 0x12, 0x21, 0x0a, 0x0c, 0x70, 0x68, 0x6f, 0x6e, 0x65,
	0x5f, 0x6e, 0x75, 0x6d, 0x62, 0x65, 0x72, 0x18, 0x03, 0x20, 0x01, 0x28, 0x09, 0x52, 0x0b, 0x70,
	0x68, 0x6f, 0x6e, 0x65, 0x4e, 0x75, 0x6d, 0x62, 0x65, 0x72, 0x22, 0x48, 0x0a, 0x12, 0x55, 0x70,
	...
	0x63, 0x0a, 0x0f, 0x47, 0x65, 0x74, 0x55, 0x73, 0x65, 0x72, 0x52, 0x65, 0x73, 0x70, 0x6f, 0x6e,
	...
	0x6d, 0x62, 0x65, 0x72, 0x32, 0xcd, 0x01, 0x0a, 0x0b, 0x55, 0x73, 0x65, 0x72, 0x53, 0x65, 0x72,
...
var file_user_proto_depIdxs = []int32{
	...
	2, // 1: proto.UserService.UpdateUser:input_type -> proto.UpdateUserRequest
	...
	3, // 4: proto.UserService.UpdateUser:output_type -> proto.UpdateUserResponse
